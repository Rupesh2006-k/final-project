...
class DriverService {
  async createProfile(userId, profileData) {
    ...
    // ✅ Ye line add karo - save se PEHLE
    driver.status.profileCompletionPercentage =
      driver.calculateProfileCompletion();

    await driver.save();
    // ✅ User ka role DRIVER karo
  ...
  async updateProfile(userId, updateData) {
    ...
    updatedDriver.status.profileCompletionPercentage =
      updatedDriver.calculateProfileCompletion();
  ...
  async getProfileCompletion(userId) {
    ...
    return {
      ...
      missingFields: driver.getMissingFields(),
